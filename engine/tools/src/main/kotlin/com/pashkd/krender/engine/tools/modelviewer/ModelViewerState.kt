...
const val DEFAULT_ENVIRONMENT_PRESET = HdrEnvironmentAssets.DEFAULT_MANIFEST
...
data class ModelViewerState(
    ...
    var pbrRendererWarning: String? = null,
    ...
    var pbrEnvironmentPreset: String = DEFAULT_ENVIRONMENT_PRESET,
    var pbrExposure: Float = 1f,
    var pbrShowSkybox: Boolean = true,
    var pbrSkyboxIntensity: Float = 1f,
    var pbrDiffuseIntensity: Float = 1f,
    var pbrSpecularIntensity: Float = 1f,
    var pbrEnvironmentRotationDegrees: Float = 0f,
    var pbrBackgroundMode: BackgroundMode = BackgroundMode.Skybox,
    var pbrBackgroundColor: Color = Color(0.08f, 0.09f, 0.11f, 1f),
    var pbrEnvironmentCacheKey: String = DEFAULT_ENVIRONMENT_PRESET,
    var pbrAppliedEnvironmentPreset: String? = null,
    ...
    var pbrWireframeOverlay: Boolean = false,
