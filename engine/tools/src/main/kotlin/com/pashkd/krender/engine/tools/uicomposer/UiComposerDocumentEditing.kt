...
fun createDefaultUiSceneNode(
    ...
    when (type) {
        ...
        UiSceneNodeType.Window -> UiSceneNode(id = id, type = type, text = "Window", spacing = 8f)
        UiSceneNodeType.Label -> UiSceneNode(id = id, type = type, text = "Label")
        UiSceneNodeType.Button -> UiSceneNode(id = id, type = type, text = "Button")
        UiSceneNodeType.TextButton -> UiSceneNode(id = id, type = type, text = "Button", action = "action.todo")
        UiSceneNodeType.CheckBox -> UiSceneNode(id = id, type = type, text = "Check option")
        UiSceneNodeType.TextField -> UiSceneNode(id = id, type = type, text = "Text")
        UiSceneNodeType.SelectBox -> UiSceneNode(id = id, type = type, items = listOf("First", "Second", "Third"))
        UiSceneNodeType.List -> UiSceneNode(id = id, type = type, items = listOf("First", "Second", "Third"))
        UiSceneNodeType.ScrollPane -> UiSceneNode(id = id, type = type)
        UiSceneNodeType.SplitPane -> UiSceneNode(id = id, type = type, splitAmount = 0.5f)
        UiSceneNodeType.Slider -> UiSceneNode(id = id, type = type, min = 0f, max = 1f, step = 0.01f, value = 0.5f)
        UiSceneNodeType.ProgressBar -> UiSceneNode(id = id, type = type, min = 0f, max = 1f, step = 0.01f, value = 0.5f)
        UiSceneNodeType.Tree -> UiSceneNode(id = id, type = type, items = listOf("Root", "Root/Child"))
        UiSceneNodeType.TextTooltip -> UiSceneNode(id = id, type = type, text = "Tooltip")
