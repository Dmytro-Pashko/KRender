...
data class UiComposerSkinMetadata(
    ...
    val buttonStyles: List<String> = emptyList(),
    val textButtonStyles: List<String> = emptyList(),
    val checkBoxStyles: List<String> = emptyList(),
    val textFieldStyles: List<String> = emptyList(),
    val selectBoxStyles: List<String> = emptyList(),
    val listStyles: List<String> = emptyList(),
    val scrollPaneStyles: List<String> = emptyList(),
    val splitPaneStyles: List<String> = emptyList(),
    val sliderStyles: List<String> = emptyList(),
    val progressBarStyles: List<String> = emptyList(),
    val treeStyles: List<String> = emptyList(),
    val textTooltipStyles: List<String> = emptyList(),
    val windowStyles: List<String> = emptyList(),
