...
// Configures the optional Graal native image binary for the desktop launcher when enableGraalNative is true.
...
// Generates the native-image resource config so desktop assets, icons, and LibGDX fonts are embedded in the binary.
