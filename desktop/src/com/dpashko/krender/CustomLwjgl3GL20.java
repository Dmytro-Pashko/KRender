...
class CustomLwjgl3GL20 implements com.badlogic.gdx.graphics.GL20 {
  ...
  public void glCompressedTexImage2D(int target, int level, int internalformat, int width,
    ...
    if (data instanceof ByteBuffer) {
      GL13.glCompressedTexImage2D(target, level, internalformat, width, height, border,
          (ByteBuffer) data);
    } else {
  ...
  public void glGetFramebufferAttachmentParameteriv(int target, int attachment, int pname,
      IntBuffer params) {
    EXTFramebufferObject.glGetFramebufferAttachmentParameterivEXT(target, attachment, pname,
        params);
  }
  ...
  public void glTexImage2D(int target, int level, int internalformat, int width, int height,
      ...
      Buffer pixels) {
		if (pixels == null) {
			...
			throw new GdxRuntimeException("Can't use " + pixels.getClass().getName()
					+ " with this method. Use ByteBuffer, ShortBuffer, IntBuffer, FloatBuffer or "
					+ "DoubleBuffer instead. Blame LWJGL");
		}
  }
  ...
  public void glVertexAttribPointer(int indx, int size, int type, boolean normalized, int stride,
    ...
    if (buffer instanceof ByteBuffer) {
			if (type == GL_BYTE) {
				...
				throw new GdxRuntimeException(
						"Can't use " + buffer.getClass().getName() + " with type " + type
								+ " with this method. Use ByteBuffer and one of GL_BYTE, GL_UNSIGNED_BYTE, "
								+ "GL_SHORT, GL_UNSIGNED_SHORT or GL_FLOAT for type. Blame LWJGL");
			}
			...
			throw new GdxRuntimeException(
					"Can't use " + buffer.getClass().getName()
