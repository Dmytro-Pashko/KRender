...
class CustomLwjgl3GL30 extends CustomLwjgl3GL20 implements com.badlogic.gdx.graphics.GL30 {
  ...
  public void glTexImage3D(int target, int level, int internalformat, int width, int height,
      int depth, int border, int format,
  ...
  public void glTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset,
    ...
    if (pixels instanceof ByteBuffer) {
      ...
      GL12.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format,
          type, (ShortBuffer) pixels);
    } else if (pixels instanceof IntBuffer) {
      GL12.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format,
          type, (IntBuffer) pixels);
    } else if (pixels instanceof FloatBuffer) {
      GL12.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format,
          type, (FloatBuffer) pixels);
    } else if (pixels instanceof DoubleBuffer) {
      GL12.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format,
          type, (DoubleBuffer) pixels);
    } else {
      throw new GdxRuntimeException("Can't use " + pixels.getClass().getName()
          + " with this method. Use ByteBuffer, ShortBuffer, IntBuffer, FloatBuffer or "
          + "DoubleBuffer instead. Blame LWJGL");
  ...
  @Override
  public void glCopyBufferSubData(int readTarget, int writeTarget, int readOffset, int writeOffset,
      int size) {
  ...
  @Override
  public void glDrawElementsInstanced(int mode, int count, int type, int indicesOffset,
      int instanceCount) {
