...
object AnimationViewerUiLayoutDefaults {
    ...
    val config = ImGuiLayoutConfig(
        panels = mapOf(
            AnimationViewerPanelIds.Toolbar to ImGuiPanelLayout(
            ...
            AnimationViewerPanelIds.Viewport to ImGuiPanelLayout(
                title = "Viewport",
                x = 16f,
                y = 152f,
                width = 420f,
            ...
            AnimationViewerPanelIds.Animations to ImGuiPanelLayout(
                title = "Animations",
                x = 452f,
                y = 152f,
                width = 360f,
            ...
            AnimationViewerPanelIds.Playback to ImGuiPanelLayout(
                title = "Playback",
                x = 828f,
                y = 152f,
                width = 360f,
