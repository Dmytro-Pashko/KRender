...
application {
    ...
    applicationName = "$appName-linux"
}

eclipse.project.name = "$appName-desktop-lwjgl3-linux"
...
tasks.register("jarLinux") {
    group = "build"
    description = "Builds the Linux desktop launcher JAR."
    dependsOn(tasks.named("jar"))
}

tasks.register("dist") {
    group = "build"
    description = "Builds the Linux desktop distribution JAR using the legacy gdx-setup task name."
    dependsOn(tasks.named("jar"))
}
